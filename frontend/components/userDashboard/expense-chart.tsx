...
const chartData = [
    ...
    { date: "2024-04-02", income: 0, expense: 180 },
    { date: "2024-04-03", income: 0, expense: 120 },
    { date: "2024-04-04", income: 0, expense: 260 },
    { date: "2024-04-05", income: 0, expense: 290 },
    { date: "2024-04-06", income: 0, expense: 340 },
    ...
    { date: "2024-04-17", income: 0, expense: 360 },
        ...
        <Card className="pt-0">
            <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
                <div className="grid flex-1 gap-1">
                    <CardTitle>Income vs Expense - Interactive</CardTitle>
                    <CardDescription>
